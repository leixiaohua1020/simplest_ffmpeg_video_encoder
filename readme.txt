...
simplest_ffmpeg_video_encoder: Simplest video encoding software based on FFmpeg. It uses libavcodec to encode video and uses libavformat to add container format to the video bitstream.
